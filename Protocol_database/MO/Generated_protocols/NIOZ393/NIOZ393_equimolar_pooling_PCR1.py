...
# =============================================================================
DNA_µL_list = [18.71, 19.55, 12.68, 45.98, 19.55, 12.95, 38.07, 12.79, 17.32, 10.0, 10.0, 12.12, 20.61, 65, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 65, 65, 12.63, 65, 12.95, 12.27, 11.18, 27.8, 65, 20.2, 10.0, 13.23, 14.43, 23.13, 65, 65, 65, 65, 65, 13.65, 10.0, 13.96, 65, 65, 10.0]
# =============================================================================
...
metadata = {
            ...
            'protocolName': 'Equimolar pooling protocol PCR1 V1.0',
