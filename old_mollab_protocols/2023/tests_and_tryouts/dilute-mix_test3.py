...
# =============================================================================
    ...
    for mix_method in range(5):
        ...
        if mix_method == 0:
            ## 1: 100x dilution, mixing 20µL 3x, rate=5
            dilution = dilution_strips.wells_by_name()['A1']
            ...
            dilution = dilution_strips.wells_by_name()['B1']
            ...
            destination = plate_96_qPCR.columns_by_name()['5']
            sample_vol_dil = sample_vol_dil1
            mix_rate = 1
            mix_location = dilution
            mix_volume = 20
            ...
            dilution = dilution_strips.wells_by_name()['E1']
            destination = (
