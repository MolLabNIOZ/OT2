...
metadata = {'author': 'NIOZ Molecular Ecology',
            'protocolName': 'Aliquoting to any labware',
...
def add_parameters(parameters: protocol_api.Parameters):
    ...
    #### Samples
    parameters.add_int(variable_name="number_of_aliquotes",
                       display_name="How many aliquotes do you have?",
                       description="Number of aliquotes you want to dilute. Max is 96 aliquotes.",
                       default=96,
                       minimum=0,
                       maximum=96,
                       unit="aliquotes")
    ...
    #### Dilution
    parameters.add_float(variable_name="aliquote_volume",
                         display_name="aliquote volume",
...
## ============================================================================
    ...
    total_reagent_volume = plankton.aliquote_volume * plankton.number_of_aliquotes
    ...
    tube_type_dict = {
        "PCR_strips" : (possible_strip_locations[math.ceil(plankton.number_of_aliquotes/8/4)], len(possible_strip_locations[math.ceil(plankton.number_of_aliquotes/8/4)])*8),
        "PCR_plate" : (False, 96),
    ...
    tip_racks_p20, tip_racks_p300, P20, P300 = LW.number_of_tip_racks_2_0(volumes_aliquoting = plankton.aliquote_volume,
                                                                          number_of_aliquotes = plankton.number_of_aliquotes,
                                                                          volumes_transfering = 0,
...
## COMMENTS====================================================================
## ============================================================================
    if plankton.aliquote_volume > 180 and plankton.final_tube_type != '1.5mL_tubes':
        check = False
    else:
        check = True
        
    if plankton.aliquote_volume < 1:
        raise Exception(f"You would like to dilute {plankton.aliquote_volume} ul. Pipetting"
    ...
    elif 1 <= plankton.aliquote_volume < 2.0:
        protocol.comment(f"You want to pipette {plankton.aliquote_volume} ul of sample. "
                         "This is possible but we advise you to increase the "
                         "final volume or lower the dilution rate a little bit.")
    elif plankton.aliquote_volume >= 2.0 and check == False:
    ...
    if plankton.final_tube_type == '1.5mL_tubes' and plankton.number_of_alioquotes > 72:
