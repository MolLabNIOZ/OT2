...
(MB) 230516:
    -Removed separate mock / NTC variables
    -Added the option to choose between separate or combined fwd/rev primers
...
# Are your fwd / rev primers combined or separate?
primers_combined = True
...
# =============================================================================
    ...
    sample_wells = wells[:number_of_samples]
      ## cuts off the list after the number_of_samples number of wells    
    ...
    F_primer_wells = F_primers[:number_of_samples]
    R_primer_wells = R_primers[:number_of_samples]
