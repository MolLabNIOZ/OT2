...
sample_volume = [30, 30, 65, 50, 40, 50, 60, 20, 30, 20, 65, 65, 60, 50, 40, 20, 65, 60, 65, 65, 65, 65, 50, 40, 40, 65, 65, 65, 30, 65, 40, 30, 40, 20, 65, 65, 65, 30, 20, 40, 65, 65, 65, 65, 20]
  ## Can be one volume or a list of volumes
  
water_volume = [41.28, 56.33, 0.0, 16.0, 35.9, 27.05, 10.29, 48.64, 62.37, 67.12, 0.0, 0.0, 12.27, 20.29, 37.35, 62.5, 0.0, 12.67, 0.0, 0.0, 0.0, 0.0, 15.18, 31.81, 41.97, 0.0, 0.0, 0.0, 60.29, 0.0, 44.22, 56.13, 38.01, 46.66, 0.0, 0.0, 0.0, 36.03, 107.38, 37.62, 0.0, 0.0, 0.0, 0.0, 94.84]
  # Can be one volume or a list of volumes.
# =============================================================================
