...
#   Same test as contamination_test.py but now with more positives than
#   negatives.
# =============================================================================
...
##### Metadata
metadata = {
    'protocolName': 'Contamination_testOT2_2 210412',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    volume decreases.
    Adding sample (16S positive control) from 1.5 mL tubes most of the wells 
    in the plate, leaving a few as NTC. 
    """
...
# =============================================================================
    ...
    for well in plate_96.wells():
        ...
        if not(well_c == 'A2 of 96well_plate on 9' or 
               ...
               well_c == 'F5 of 96well_plate on 9' or
               well_c == 'D6 of 96well_plate on 9' or
               well_c == 'B7 of 96well_plate on 9' or
               well_c == 'F7 of 96well_plate on 9' or
               well_c == 'D8 of 96well_plate on 9' or
               well_c == 'B9 of 96well_plate on 9' or
               well_c == 'F9 of 96well_plate on 9' or
               well_c == 'A11 of 96well_plate on 9'):
            p20.pick_up_tip()
              ## p20 picks up tip from location specified in variable       ## 
              ## starting_tip                                               ##
            p20.aspirate(sample_vol, sample_tubes['A1'])
              ## Aspirate sample volume from well A1 in sample_tubes.       ##
