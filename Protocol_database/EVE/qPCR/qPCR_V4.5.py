...
# =============================================================================
    ...
    if plankton.duplo == True:
        ...
        source_locations = sample_tubes_location + mock_tubes_location + sample_tubes_location + mock_tubes_location + (standard_sample_tube_location * plankton.number_of_std_samples)
        ...
        source_locations = sample_tubes_location + mock_tubes_location + (standard_sample_tube_location * plankton.number_of_std_samples)
