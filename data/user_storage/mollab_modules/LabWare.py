...
def defining_liquids(reagent_type, 
    ...
    reagent_dict = {
        ...
        'primer_stocks': ['primer stocks', 'The pcr strips containing the barcoded primer stocks','#1F34B9'],
        'primer_working_dilution': ['primer working dilution', 'The pcr strips containing the barcoded primer working dilution','#00E0FF'],
