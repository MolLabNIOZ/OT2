...
metadata = {'author': 'NIOZ Molecular Ecology',
            'protocolName': 'Diluting samples in different tube types V1.5',
...
def add_parameters(parameters: protocol_api.Parameters):
    ...
    parameters.add_float(variable_name="final_volume",
                         ...
                         description="what would you like to be your final volume after diluting?",
                         default=30.0,
                         minimum=10.0,
                         maximum=1400.0,
                         unit="µl")
    ...
    #### Lights/Pause  
    parameters.add_bool(variable_name="adding_sample",
                        display_name="adding sample",
                        description="Do you want to add sample to your dilution?",
                        default= False)
...
## ============================================================================
    ...
    if plankton.adding_sample == False:
