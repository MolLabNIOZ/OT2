...
(SV) 220718:
    - added offset parts that are needed for the new robot update (API V2.12)
"""
# VARIABLES TO SET#!!!=========================================================
# =============================================================================
...
# =============================================================================
    ...
    if simulate: #Simulator
        ...
        if sample_tubes == 'PCR_strips':  
            sample_strips_1 = protocol.load_labware( #note 220718 was sample_tubes_1
