...
(MB) 230314:
    -Changed plate on coolrack to plate on NIOZholder 
(MB) 230419:
    -Added the option to skip samples
"""
# VARIABLES TO SET#!!!=========================================================
# =============================================================================
...
samples_to_skip = [4,5,7,9,12,13,16,31,32,39,40,41,42,53,54,
...
# =============================================================================
    ...
    if sample_tubes == 'PCR_strips':
        ...
        for index in sorted(samples_to_skip, reverse=True):
        ...
        # Location of PCR reactions    
        sample_destinations = plate_96.wells()
        ## Remove wells to skipp
        for index in sorted(samples_to_skip, reverse=True):
            del sample_destinations[index]
            # In reverse order, so that the index does not shift
...
## ADDING SAMPLES--------------------------------------------------------------
    ...
    for sample_tube, well in zip(sample_sources, sample_destinations):
        p20.pick_up_tip()
