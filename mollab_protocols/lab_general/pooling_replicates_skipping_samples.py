...
230420 MB:  -Slower pipetting, hopefully this empties the wells better
"""
...
# If i using strips, in which columns are the strips in the plate 
# (ignored if not using strips)?
sample_columns = ['2', '5', '8','11']
  ## optional: ['2', '7', '11'] or ['2', '5', '8','11']                     
   
# Are there any wells in the plate that need to be skipped
skipp_samples = True
...
## ============================================================================
    ...
    if replicates == 2:
        for well_PCR2, well_PCR1 in zip(PCR2_wells, PCR1_wells):
            pipette.pick_up_tip()
            pipette.aspirate(transfer_volume, well_PCR2, rate=0.2)
            pipette.dispense(transfer_volume, well_PCR1)
            pipette.dispense(20, well_PCR1)
            pipette.drop_tip()
    ...
    if replicates == 3:
        for well_PCR3, well_PCR2, well_PCR1 in zip(
            ...
            pipette.pick_up_tip()
            pipette.aspirate(reaction_volume + 5, well_PCR3, rate=0.2)
            pipette.aspirate(reaction_volume + 5, well_PCR2, rate=0.2)
            pipette.dispense(transfer_volume, well_PCR1)
            pipette.dispense(20, well_PCR1)
            pipette.drop_tip()        
# =============================================================================
