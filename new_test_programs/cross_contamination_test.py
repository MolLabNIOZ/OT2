...
# Loading labware
    tips_200 = protocol.load_labware('opentrons_96_filtertiprack_200ul', 7, 
                                     '200tips')
    tips_20 = protocol.load_labware('opentrons_96_filtertiprack_20ul', 4,
                                    '20tips')
    plate_96 = protocol.load_labware('biorad_96_wellplate_200ul_pcr', 9,
                                     '96well_plate')
    std_tubes = protocol.load_labware(
        'opentrons_24_tuberack_eppendorf_1.5ml_safelock_snapcap', 8,
        '1.5mL_tubes')
    tubes_5mL = protocol.load_labware(
        'opentrons_15_tuberack_falcon_15ml_conical', 6, '5mL_tubes')
