...
def defining_liquids(reagent_type, 
    ...
    reagent_dict = {
        ...
        'samples2': ['Samples', 'The samples in the strips/tubes','#ffcaff'],
        ...
        'NTC2': ['NTC', 'Reaction without template volume','#fa9898'],
        'Mock': ['MOCK', 'The tube containing your MOCK','#239B56'],
        'Mock2': ['MOCK', 'The tube containing your MOCK','#4abf7c'],
